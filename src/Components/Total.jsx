    ...
    <div className='bcg_total pb-5 pt-lg-5'>
        <Container className='my_container pb-5 pt-5'>
            <div className='text-center'>
                <h2 className=' fs_52 ff_Jakarta fw_700 text-white' data-aos="zoom-in" data-aos-duration="2000">170k Total Starting Supply</h2>
                <p className=' ff_Raleway fs_16 fw_500 text-white pt-3 pt-md-0' data-aos="zoom-out" data-aos-duration="2000">Initial BONDing Offering (IBO)* Phases</p>
            </div>
            <div className=' overflow-x-scroll scroll_bttn'>
