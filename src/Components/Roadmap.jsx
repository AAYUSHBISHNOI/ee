            ...
            <div class="content ">
              ...
              <ul className=" mt-3">
                <li className=" fw_400 fs_16 ff_Raleway text-white  ms-3">
                  ...
                  <li>
                    {" "}
                    INO [Initial NFT Offering]: Social Elastic NFT{" "}
                ...
                <li className=" fw_400 fs_16 ff_Raleway text-white mt-2  ms-3">
                  ...
                  <span className=" d-lg-block">
                    development and begin governance
                  </span>{" "}
                  activities{" "}
                </li>
              </ul>
            ...
            <div class="content ">
              ...
              <ul className=" mt-3">
                <li className=" fw_400 fs_16 ff_Raleway text-white  ms-3">
                  ...
                  <span className=" d-lg-block">
                    develop risk and due-diligence procedures
                  </span>{" "}
                  <span className=" d-lg-block">
                    {" "}
                    associated with strategy development and
                  </span>{" "}
                  implementation
                </li>
                <li className=" fw_400 fs_16 ff_Raleway text-white  mt-2 ms-3">
                ...
                <li className=" fw_400 fs_16 ff_Raleway text-white mt-2  ms-3">
                  ...
                  <span className=" d-lg-block">
                    {" "}
                    tokenomics for $EFT (Elastic Protocol
                  </span>{" "}
                  governance token)
                </li>
                <li className=" fw_400 fs_16 ff_Raleway text-white mt-2  ms-3">
                  ...
                  <span className=" d-lg-block">
                    {" "}
                    (beta): treasury bolster fundraise
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div class="content ">
              ...
              <ul className=" mt-3">
                ...
                <li className=" fw_400 fs_16 ff_Raleway text-white  mt-2 ms-3">
                  ...
                  for Multi-chain yield strategies
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="content ">
              ...
              <ul className=" mt-3">
                <li className=" fw_400 fs_16 ff_Raleway text-white  ms-3">
                  ...
                  governance
                  <span className=" d-lg-block">
                    Community: Complete decentralization of
                  </span>
                  <span className=" d-lg-block">
                    Elastic Finance DAO, its treasury, its yield
                  </span>
                </li>
              </ul>
            </div>
