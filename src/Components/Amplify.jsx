...
const Amplify = () => {
  ...
  return (
    <div className='position-relative mt-md-5 pt-md-5 pt-lg-0 mt-lg-0'>
    <div className='bcg_section_2'>
      <div className='text-center py-3  d-none d-md-block'>
      <h2 className='ff_machina fs_52 fw_800 text-white ' data-aos="zoom-in-up" >Amplify and <span className='text-uppercase'>stretch gains</span></h2>
      </div>
      ...
      <img className='w-100 img_cloud' data-aos="zoom-out"  src={cloud} alt="" />
    </div>
    </div>
  )
}
